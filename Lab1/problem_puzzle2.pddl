...
(:init 
    ; PUZZLE 2 
    (spacecraft_at red s1 s1) ; initial position red spacecraft
    (spacecraft_at orange s2 s5) (spacecraft_at yellow s4 s1) (spacecraft_at green s4 s4) (spacecraft_at purple s2 s2) ; initial position helpers
